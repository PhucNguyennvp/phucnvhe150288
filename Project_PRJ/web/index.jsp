                    ...
                    <c:forEach items="${requestScope.listC}" var="c">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="shop-cat-box">
                                <img class="img-fluid" src="${c.images}" alt="" style="height:350px; width:350px" />
                                <a class="btn hvr-hover" href="category?cid=${c.cid}">${c.cname}</a>
                            </div>
                        </div>
                    </c:forEach>                    
                </div>
            ...
            <div class="container">
                ...
                <div class="row special-list">
                    <c:forEach items="${requestScope.listP}" var="c">
                        <div class="col-12 col-md-6 col-lg-3 special-grid best-seller">
                            ...
                            <div class="products-single fix">
                                ...
                                <div class="why-text">
                                    ...
                                    <h5 class="text-center">$${c.price}</h5>
                                </div>
                            </div>
